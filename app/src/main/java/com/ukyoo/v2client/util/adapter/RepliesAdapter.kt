...
class RepliesAdapter(layoutResId: Int) :
    BaseQuickAdapter<ReplyListModel.ReplyItemModel, RepliesAdapter.VHolder>(layoutResId) {
...
//        var itemPresenter: ItemClickPresenter = null
    ...
    override fun convert(helper: VHolder, item: ReplyListModel.ReplyItemModel?) {
